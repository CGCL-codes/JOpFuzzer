/*
 * Ident: @(#)instr_01303m1.java generated from: @(#)instr_01303m.jmpp
 *
 * Copyright (c) 2013,  Oracle and/or its affiliates. All rights reserved.
 */

package javasoft.sqe.tests.vm.classfmt.ins.instr_013.instr_01303m1;

import java.io.PrintStream;
import java.lang.reflect.*;

public class instr_01303m1 {

    public static int run(String argv[], PrintStream out) {

    if (runPositive("instr_01303m10p", argv, out) != 0/*STATUS_PASSED*/)
        return 2/*STATUS_FAILED*/;
    if (instantiateNegative("instr_01303m11n", VerifyError.class, argv, out) != 0/*STATUS_PASSED*/)
        return 2/*STATUS_FAILED*/;
    ...
    try {
        goodClass = Class.forName("javasoft.sqe.tests.vm.classfmt.ins.instr_013.instr_01303m1." + testName);
    } catch (ThreadDeath e) {
        throw e;
    } catch (Throwable e) {
    ...
    public static int instantiateNegative(String testName, Class expectedException, String argv[], PrintStream out) {
        ...
        Class badClass = null;
        try {
            badClass = Class.forName("javasoft.sqe.tests.vm.classfmt.ins.instr_013.instr_01303m1." + testName);
            try {
