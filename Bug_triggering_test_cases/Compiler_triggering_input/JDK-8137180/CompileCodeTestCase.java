...
public final class CompileCodeTestCase {
    ...
    private CompileCodeTestCase(Executable executable, int bci) {
    ...
    public NMethod compile() {
        ...
        if (!enqueued) {
            throw new Error(String.format(
                    ...
                    executable, bci >= 0 ? "osr-" : "", COMP_LEVEL));
        }
    ...
    public static interface Interface {
        ...
        default Long defaultOverridedMethod(Interface[] array) {
    ...
    public static abstract class Dummy implements Interface {
        protected Dummy() {
        }
        ...
        @Override
        public Long defaultOverridedMethod(Interface[] array) {
            return 0L;
        }
    }
